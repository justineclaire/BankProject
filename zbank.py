...
def interface(cust1, acc1):
    ...
    while option != '9':
        ...
        print("1. Check Balance\n2. Deposit to own account\n3. Transfer funds\n4. Withdraw cash")
        print("5. View Recent Transactions\n6. Use interest/Mortgage calculator\n7. Manage cards\n8. Close Account")
...
def main():
    ...
    Option 1: 'Login' if you have a customer account, Option 2: 'Register' if you do not have a customer account
